      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-start justify-between mb-3">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100">{match.full_name}</h3>
              <p className="text-sm text-gray-600 dark:text-slate-400">{match.email}</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div className="flex items-center gap-2">
              <Award className="h-4 w-4 text-gray-400 dark:text-slate-500" />
              <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs text-gray-500 dark:text-slate-400">Availability</p>
                <p className="text-sm font-medium text-gray-900 dark:text-slate-100">
